...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Vitals360 - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Vitals360 - React.js Tailwind CSS Admin Dashboard Template"
      />
