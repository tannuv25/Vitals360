...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Vitals360 - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Vitals360 - React.js Tailwind CSS Admin Dashboard Template"
      />
